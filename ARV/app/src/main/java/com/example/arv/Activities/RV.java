...
public class RV extends AppCompatActivity {
   ...
   public String number;
    ...
    public void jsonrequest() {
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(RV.this);

        //Get the bundle
        Intent intent = getIntent();

        number= intent.getStringExtra("vishal");
...
//                        Patients patients = new Patients();
                ...
                {
                    Toast.makeText(RV.this,""+e,Toast.LENGTH_SHORT).show();
                    Log.i("vishal",e.toString());
                }
//                Toast.makeText(RV.this,result,Toast.LENGTH_SHORT).show();
